--Cam Options--
bfZoom = 0.5 --The Zoom amount on the player (default is 1.05, but on mainStage it's 0.9)
dadZoom = 0.46 --The Zoom amount on the opponent (default is 1.05, but on mainStage it's 0.9)
gfZoom = 0.45 --The Zoom amount on the opponent (default is 1.05, but on mainStage it's 0.9)
...
function onEvent(name, value1, value2)
	if name == 'changeZoomNumber' then -- Change the name to your choice
		...
		elseif value1 == 'dad' or value1 == 'Dad' then
			dadZoom = value2
		elseif value1 == 'gf' or value1 == 'GF' then
			gfZoom = value2
