--Cam Options--
bfZoom = 1 --The Zoom amount on the player (default is 1.05, but on mainStage it's 0.9)
dadZoom = 1 --The Zoom amount on the opponent (default is 1.05, but on mainStage it's 0.9)
gfZoom = 1 --The Zoom amount on the opponent (default is 1.05, but on mainStage it's 0.9)
