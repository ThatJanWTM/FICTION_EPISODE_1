...
function onCreatePost()
    --              ID  red       green     blue
    setNoteColorDad(0, 'c24b99', 'FFFFFF', '3c1f56');
    setNoteColorDad(1, '00ffff', 'FFFFFF', '1542b7');
    setNoteColorDad(2, '12fa05', 'FFFFFF', '0a4447');
    setNoteColorDad(3, 'f9393f', 'FFFFFF', '651038');
end